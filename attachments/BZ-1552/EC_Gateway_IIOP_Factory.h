...
class TAO_ECG_ConsumerEventChannelControl;
...
public:
  ...
  TAO_ECG_ConsumerEventChannelControl *
      create_consumer_eventchannel_control (TAO_EC_Gateway_IIOP* gateway);

  /// Destroy consumer event channel control.
  void destroy_consumer_eventchannel_control (TAO_ECG_ConsumerEventChannelControl* x);
private:

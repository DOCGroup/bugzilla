// $Id: Logging_Strategy_Test.cpp 84315 2009-02-03 15:58:39Z mitza $
...
ACE_RCSID(tests, Logging_Strategy_Test, "$Id: Logging_Strategy_Test.cpp 84315 2009-02-03 15:58:39Z mitza $")
...
static bool rotate_with_log_msg = false;
...
parse_args (int argc, ACE_TCHAR *argv[])
{
  ...
  ACE_Get_Opt get_opt (argc, argv, ACE_TEXT ("s:i:m:f:N:owr"));
  int c;
  ...
  while ((c = get_opt ()) != EOF)
    {
      switch (c)
        ...
        case 'r':
          ACE_DEBUG ((LM_DEBUG,
                      ACE_TEXT ("rotate with log_msg activated\n")));
          rotate_with_log_msg = true;
	  break;
        default:
          ACE_ERROR_RETURN
            ((LM_ERROR,
              ...
              ACE_TEXT ("\t-r: If activated cause the logfiles to be rotated according to a counter in Log_Msg,")

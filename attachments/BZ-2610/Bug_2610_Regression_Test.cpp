 ...
 *
 * $Id: Bug_2610_Regression_Test.cpp 55322 2004-01-10 21:20:20Z shuston $
 *
...
protected:
	...
	int activate_svc_handler (My_Svc_Handler* svc_handler)
	{
		...
		super::activate_svc_handler(svc_handler);
		g_semaphore.release();
		return -1;
	}
};
...
run_main (int, ACE_TCHAR *[])
{
  ...
  g_semaphore.acquire();// wait for reactor to start
  {
    ...
    {
      ACE_ERROR ((LM_ERROR, ACE_TEXT("Could not connect\n")));
    }

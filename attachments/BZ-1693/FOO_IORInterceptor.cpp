...
ACE_RCSID (IORInterceptor,
           FOO_IORInterceptor,
           "$Id: FOO_IORInterceptor.cpp,v 1.9 2003/10/28 18:30:57 bala Exp $")
  ...
  ACE_THROW_SPEC ((CORBA::SystemException))
{
  ...
  FOO::OTSPolicyValue tpv = FOO::REQUIRES; // == (unsigned short) 2
  ...
  ACE_DEBUG ((LM_DEBUG,
              ...
              "(%P|%t)   OTSPolivyValue \"%x\" to all profiles.\n",
              tpv));
  ...
  ACE_DEBUG ((LM_DEBUG,
              "(%P|%t) Added tagged component containing the\n"
              "(%P|%t)   OTSPolicyValue \"%x\" to all IIOP profiles.\n",
              tpv));

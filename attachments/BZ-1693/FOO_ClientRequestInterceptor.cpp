...
ACE_RCSID (IORInterceptor,
           ...
           "$Id: FOO_ClientRequestInterceptor.cpp,v 1.7 2003/10/28 18:30:57 bala Exp $")
                   ...
                   PortableInterceptor::ForwardRequest))
{
  ...
  CORBA::Any_var decoded_data =
    this->codec_->decode_value (data,
                                FOO::_tc_OTSPolicyValue        // C.L. this typecode does not work :(
                                // CORBA::_tc_ushort              // C.L.: this typcode works
                                ACE_ENV_ARG_PARAMETER);
  ACE_CHECK;

  const char * name = 0;
  FOO::OTSPolicyValue tpv=0;
  ...
  */
  ...
  ACE_DEBUG ((LM_DEBUG,
              "(%P|%t) OTSPolicyValue extracted from tagged component "
              "data: %x\n",tpv));

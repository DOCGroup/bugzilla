// -*- C++ -*-
//
// $Id: CDR_Base.inl 78155 2007-04-23 13:54:04Z johnnyw $

#if defined (_MSC_VER) && (_MSC_VER >= 1300) && !(defined (__INTEL_COMPILER) && (__INTEL_COMPILER == 900)) && !(defined (ACE_HAS_WINCE))

// $Id: writer.cpp 80826 2008-03-04 14:51:23Z wotte $

#include "ace/DEV_Connector.h"
#include "ace/TTY_IO.h"
#include "ace/OS_NS_unistd.h"

ACE_RCSID(writer, writer, "$Id: writer.cpp 80826 2008-03-04 14:51:23Z wotte $")
...
int ACE_TMAIN (int argc, ACE_TCHAR *argv[])
{
  ...
  // Read default params if ACE_TTY_IO implementation supports
  // ACE_TTY_IO::GETPARAMS action.
  if (write_dev.control (ACE_TTY_IO::GETPARAMS,
                        &myparams) == -1)
    {
      // Default params must be set manually.
      ACE_DEBUG ((LM_DEBUG, ACE_TEXT("GETPARAMS not supported\n")));
      myparams.xonlim = 0;
      myparams.xofflim = 0;

// Naming_Service.cpp,v 1.58 2001/10/05 21:49:56 schmidt Exp

#include "ace/Get_Opt.h"
#include "Naming_Service.h"
#include "ace/Thread_Manager.h"

ACE_RCSID(Naming_Service, Naming_Service, "Naming_Service.cpp,v 1.58 2001/10/05 21:49:56 schmidt Exp")
...
void
TAO_Naming_Service::run_i(void* args) {
  TAO_Naming_Service* service = static_cast<TAO_Naming_Service*>(args);
  ACE_DEBUG((LM_DEBUG, "Launching thread %t\n"));
  service->orb_->run();
}
...
TAO_Naming_Service::run (CORBA_Environment& ACE_TRY_ENV)
{
  if (time_ == 0)
  {
    if (ACE_Thread_Manager::instance()->spawn_n(5,
      ACE_THR_FUNC(run_i), this,
